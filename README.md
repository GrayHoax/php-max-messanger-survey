...
## Как отображается диалог с ботом

![Пользователю предлагается ответить на вопросы путем нажатия на кнопки или текстом](https://github.com/GrayHoax/php-max-messanger-survey/raw/master/assets/demo.png)
